...
# Create client once at module level — paste your key from console.groq.com
_groq_client = Groq(api_key="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")
